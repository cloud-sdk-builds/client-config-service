...
[`@aws-sdk/client-config-service`](https://www.npmjs.com/package/@aws-sdk/client-config-service/v/3.1052.0).
...
- @aws-sdk/client-config-service v3.1052.0 - [https://cloud-sdk-builds.github.io/?sdk=client-config-service&version=3.1052.0](https://cloud-sdk-builds.github.io/?sdk=client-config-service&version=3.1052.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.1052.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-g1d1CU+BWQRjc17M+DfeNEz0Qe6litOOlS8+L8Kr/r6Tz5BwxaZVXsV6KLZPuVt9
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-config-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.1052.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.1052.0/index.min.mjs": "sha384-g1d1CU+BWQRjc17M+DfeNEz0Qe6litOOlS8+L8Kr/r6Tz5BwxaZVXsV6KLZPuVt9"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-config-service";
...
```
https://github.com/cloud-sdk-builds/client-config-service/blob/refs/tags/3.1052.0/LICENSE
```
