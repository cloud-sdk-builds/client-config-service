...
[`@aws-sdk/client-config-service`](https://www.npmjs.com/package/@aws-sdk/client-config-service/v/3.1049.0).
...
- @aws-sdk/client-config-service v3.1049.0 - [https://cloud-sdk-builds.github.io/?sdk=client-config-service&version=3.1049.0](https://cloud-sdk-builds.github.io/?sdk=client-config-service&version=3.1049.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.1049.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TPbxVwzESgoyt3srMIjGfBDamik+WBeurMz/iLkmrhqv7khZsxcNoIfJqTL91ZrS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-config-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.1049.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.1049.0/index.min.mjs": "sha384-TPbxVwzESgoyt3srMIjGfBDamik+WBeurMz/iLkmrhqv7khZsxcNoIfJqTL91ZrS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-config-service/blob/refs/tags/3.1049.0/LICENSE
```
