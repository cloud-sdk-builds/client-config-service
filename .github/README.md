...
[`@aws-sdk/client-config-service`](https://www.npmjs.com/package/@aws-sdk/client-config-service/v/3.1059.0).
...
- @aws-sdk/client-config-service v3.1059.0 - [https://cloud-sdk-builds.github.io/?sdk=client-config-service&version=3.1059.0](https://cloud-sdk-builds.github.io/?sdk=client-config-service&version=3.1059.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.1059.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bHhGfCBOcqdE8UBC7Ny0FErU4S3LZo31204YFDFB7B71b/oxRdqIi8Vxwz5ee4hG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-config-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.1059.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.1059.0/index.min.mjs": "sha384-bHhGfCBOcqdE8UBC7Ny0FErU4S3LZo31204YFDFB7B71b/oxRdqIi8Vxwz5ee4hG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-config-service/blob/refs/tags/3.1059.0/LICENSE
```
