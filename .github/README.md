...
[`@aws-sdk/client-config-service`](https://www.npmjs.com/package/@aws-sdk/client-config-service/v/3.1112.0).
...
- @aws-sdk/client-config-service v3.1112.0 - [https://cloud-sdk-builds.github.io/?sdk=client-config-service&version=3.1112.0](https://cloud-sdk-builds.github.io/?sdk=client-config-service&version=3.1112.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.1112.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z8OInEd1TXLVkyWbnb7gZr8fud3rR+FAZaDpmYl04vPJAB5ik/xlt1D+H490hK2t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-config-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.1112.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.1112.0/index.min.mjs": "sha384-Z8OInEd1TXLVkyWbnb7gZr8fud3rR+FAZaDpmYl04vPJAB5ik/xlt1D+H490hK2t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-config-service/blob/refs/tags/3.1112.0/LICENSE
```
