...
[`@aws-sdk/client-config-service`](https://www.npmjs.com/package/@aws-sdk/client-config-service/v/3.1063.0).
...
- @aws-sdk/client-config-service v3.1063.0 - [https://cloud-sdk-builds.github.io/?sdk=client-config-service&version=3.1063.0](https://cloud-sdk-builds.github.io/?sdk=client-config-service&version=3.1063.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.1063.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WilrnwZVNeagJNL/tSEmk+UA6D7fzUt4FrePi50npt37cp8zQCSgG9njNdIaN6Ys
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-config-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.1063.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.1063.0/index.min.mjs": "sha384-WilrnwZVNeagJNL/tSEmk+UA6D7fzUt4FrePi50npt37cp8zQCSgG9njNdIaN6Ys"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-config-service/blob/refs/tags/3.1063.0/LICENSE
```
