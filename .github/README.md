...
[`@aws-sdk/client-config-service`](https://www.npmjs.com/package/@aws-sdk/client-config-service/v/3.1091.0).
...
- @aws-sdk/client-config-service v3.1091.0 - [https://cloud-sdk-builds.github.io/?sdk=client-config-service&version=3.1091.0](https://cloud-sdk-builds.github.io/?sdk=client-config-service&version=3.1091.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.1091.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8Z6lvLlBR1mLWem0kWfT2Yd6hExXY2WhoHZOVfp/WmJ8tWPMLiCC8da0lWwHh7bH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-config-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.1091.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.1091.0/index.min.mjs": "sha384-8Z6lvLlBR1mLWem0kWfT2Yd6hExXY2WhoHZOVfp/WmJ8tWPMLiCC8da0lWwHh7bH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-config-service/blob/refs/tags/3.1091.0/LICENSE
```
