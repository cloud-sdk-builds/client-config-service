...
[`@aws-sdk/client-config-service`](https://www.npmjs.com/package/@aws-sdk/client-config-service/v/3.855.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.855.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-idpivSVcsD/881f/PIuhtjTvOUtUlW1+VlFasORau7EQDHyQJUuCfPMvGLHXZF+Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-config-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.855.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-config-service@3.855.0/index.min.mjs": "sha384-idpivSVcsD/881f/PIuhtjTvOUtUlW1+VlFasORau7EQDHyQJUuCfPMvGLHXZF+Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-config-service/blob/refs/tags/3.855.0/LICENSE
```
